...
Use Copilot CLI for all of these — mix `@file` context, `/plan`, `/agent`, `/skills`, `/mcp`, normal mode, and `/review` as needed.
...
- 🎓 [GitHub Copilot CLI for Beginners](https://github.com/github/copilot-cli-for-beginners) — A deeper, chapter-by-chapter course on agents, skills, and MCP
- 🌟 [Awesome GitHub Copilot](https://github.com/github/awesome-copilot) — Community agents, skills, and instruction files
